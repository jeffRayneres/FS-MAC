...
# Generated: Sat Dec 17 19:33:27 2016
##################################################
...
class transceiver_OQPSK(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.fsmac_csma_0 = fsmac.csma(2, 0, True)
        ...
        self.msg_connect((self.blocks_tagged_stream_to_pdu_0, 'pdus'), (self.fsmac_decision_0, 'sens2 in'))    
        ...
        self.msg_connect((self.fsmac_csma_0, 'pdu out'), (self.ieee802_15_4_oqpsk_phy_0, 'txin'))    
        self.msg_connect((self.fsmac_csma_0, 'app out'), (self.ieee802_15_4_rime_stack_0, 'fromMAC'))    
        self.msg_connect((self.fsmac_decision_0, 'troca out'), (self.blocks_message_debug_0, 'print'))    
        self.msg_connect((self.fsmac_sens_num_senders_0, 'dec out'), (self.blocks_message_debug_0, 'print'))    
        self.msg_connect((self.fsmac_sens_num_senders_0, 'dec out'), (self.fsmac_decision_0, 'sens1 in'))    
        self.msg_connect((self.ieee802_15_4_oqpsk_phy_0, 'rxout'), (self.fsmac_csma_0, 'pdu in'))    
        ...
        self.msg_connect((self.ieee802_15_4_rime_stack_0, 'toMAC'), (self.fsmac_csma_0, 'app in'))    
        self.msg_connect((self.uhdgps_cpdu_average_power_0, 'cpdus'), (self.blocks_pdu_remove_0, 'pdus'))    
        self.connect((self.blocks_null_source_0, 0), (self.blocks_tagged_stream_to_pdu_0, 0))    
